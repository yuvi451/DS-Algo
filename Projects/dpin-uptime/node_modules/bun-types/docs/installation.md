...
To install a specific version of Bun, you can pass the git tag of the version you want to install to the install script, such as `bun-v1.2.0` or `bun-v1.2.20`.
...
```sh
# PowerShell:
$ iex "& {$(irm https://bun.com/install.ps1)} -Version 1.2.20"
```
